...
public class CommonMethods extends PageInitializer {
    ...
    public static void openBrowserAndLaunchApplication() {
        ...
        Log.warning("My test case might have some trival issues");
    ...
    {
        Log.info("This case test is about to get completed");
        Log.endTestCAse("This case test is finished");
        driver.close();
    }
    ...
    {
        // this casts the WEbrdiver instance 'driver' to take screenshot interface
        TakesScreenshot ts=(TakesScreenshot)driver;
        // this captures the screenShot and stores it as a byte array
        byte[] picBytes=ts.getScreenshotAs(OutputType.BYTES);

        //This captures the screenshot and stores it as a file in the sourceFile varible
